...
const Article3 = () => {
    return(
        <div className="h-80 w-60 bg-blue-500 relative rounded-lg shadow-xl transition duration-300 hover:shadow-2xl">
            ...
            <button className="h-8 w-20 rounded-md bg-white text-blue-500 duration-300 relative left-20 top-36 focus:bg-blue-500 focus:border-white focus:text-white border-2">ادامه</button>
        </div>
    );
}
