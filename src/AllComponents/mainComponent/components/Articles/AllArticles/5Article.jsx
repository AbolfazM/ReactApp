...
const Article5 = () => {
    return(
        <div className="h-80 w-60 bg-blue-500 relative -top-60 left-20 rounded-lg shadow-xl transition duration-300 hover:shadow-2xl">
            ...
            <div>
                <div className="bg-white w-44 h-3 absolute left-8 text-center mt-10 rounded-sm">
            ...
            <button className="h-8 w-20 rounded-md bg-white text-blue-500 duration-300 relative left-20 top-36 focus:bg-blue-200">ادامه</button>
        </div>
    );
}
